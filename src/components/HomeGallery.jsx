...
const HomeGallery = () => {
    return (
        <section id="gallery" className="w-screen min-h-screen pt-6 border-t-2 border-[#D9D9D9] bg-brownpage">
            {/* Judul */}
            ...
            {/* Gallery Grid */}
            <div className="max-w-7xl min-h-[75vh] mx-auto p-4">
                {/* Top */}
                <div className="grid grid-cols-6 gap-4">
                    <div className="col-start-1 col-end-3 w-full h-[324px] rounded-lg  ">
                    ...
                    <div className="col-start-3 col-end-6">
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="w-full h-[150px] col-span-2 rounded-lg ">
                    ...
                    <div className="w-full h-[324px]  rounded-lg ">
                        <img src={Top6} alt="" className="w-full h-full object-fill rounded-lg hover:scale-105 transition-transform duration-300 ease-in-out" />
                    </div>
                </div>
                {/* Bottom */}
                <div className="mt-8 grid grid-cols-6 gap-4">
                    <div className="col-start-1 col-end-2 w-full h-[324px] rounded-lg ">
                       <img src={Bottom1} alt="" className="w-full h-full object-cover rounded-lg hover:scale-105 transition-transform duration-300 ease-in-out" />
                    </div>
                    ...
                    <div className="col-start-5 col-end-7 w-full h-[324px] rounded-lg ">
